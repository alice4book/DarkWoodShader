...
half4 CombinedShapeLightShared(half4 color, half4 mask, half2 lightingUV, half2 worldUV)
{
    ...
    finalOutput = color;
#else
    half4 finalModulate = shapeLight0Modulate + shapeLight2Modulate * visionMask + shapeLight1Modulate;
    half4 finalAdditve = shapeLight0Additive + shapeLight2Additive * visionMask + shapeLight1Additive;
